...
if ($_SERVER['PHP_SELF'] != '/index.php') {
	echo '<div class="foot"><img src="' . $set['siteurl'] . '/style/icons/icon_glavnaya.gif" alt="*" /> <a href="/index.php">返回首页</a></div>';
}
?>
<div class="copy">
	&copy; <a href="<?php echo $set['siteurl']; ?>" style="text-transform: capitalize;"><?php echo text($_SERVER['HTTP_HOST']); ?></a> - <?php echo date('Y'); ?> 
</div>
<div class="foot">
	在网站上: 
