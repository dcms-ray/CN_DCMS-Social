...
if (isset($user)) {
	if (!isset($user) && !isset($_GET['id'])) header("Location: /index.php?" . session_id());
	...
	echo "<div id='inf'>
			...
			<span class=\"ank_n\">评级:</span> <span class=\"ank_d\">$user[rating]</span><br />";
	if ($user['level'] > 0) {
	...
	echo "<div class='form'>
			...
			密码 (<a href='/user/pass.php'>忘记了</a>):<br /><input type='password' name='pass' maxlength='32' /><br />
			<input type='submit' value='登录' />
			</form>
			<a href='/user/reg.php'><b>注册</b></a><br /></div>";
}
echo '</div>';