...
<table>
	<div id="footer" class="gradient_grey">
		<div class="body_width_limit">
			<span id="copyright">
				<a href="/user/users.php">已登记 (<?php echo dbresult(dbquery("SELECT COUNT(`id`)FROM `user`"),0); ?>)</a>
			</span>
			<span id="copyright">
			...
			<span id="language">
				<a href="/index.php"><font style="text-transform: capitalize;">© <?php echo htmlspecialchars($_SERVER['HTTP_HOST']); ?> - <?php echo date('Y'); ?> </font></a></span>
			<span id="generation">
				<?php
