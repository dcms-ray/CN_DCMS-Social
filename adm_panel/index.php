...
if (isset($_SESSION['adm_auth']) && $_SESSION['adm_auth'] > $time || isset($_SESSION['captcha']) && isset($_POST['chislo']) && $_SESSION['captcha'] == $_POST['chislo']) {
	...
	if ($status_version_data['success'] && version_compare($set['dcms_version'], $status_version_data['version']) <= 0) {
		echo "<center><font color='red'>有个新版本 - " . $status_version_data['version'] . "! <a href='update.php'>详细信息</a></font></center>	";
	...
	echo "<img src='../captcha.php' width='100' height='30' alt='验证码' /><br />从图片中输入数字:<br //><input name='chislo' size='5' maxlength='5' value='' type='text' /><br/>";
