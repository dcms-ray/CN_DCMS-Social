...
if ($_SERVER['PHP_SELF'] != '/index.php') {
	echo '<div class="foot"><img src="/assets/icons/icon_glavnaya.gif" alt="*" /> <a href="/index.php">返回首页</a></div>';
}
?>
<div class="copy">
...
<div class="foot">
	...
	<a href="/user/online_g.php"><?php echo dbresult(dbquery("SELECT COUNT(*) FROM `guests` WHERE `date_last` > ".(time()-600)." AND `pereh` > '0'"), 0); ?></a> | <a href="/?t=web">电脑版</a>
</div>
<div class="rekl">
	<?php
	...
	rekl(3);
	?>
	页面执行时间: <?php if (isset($sec, $msec, $conf['headtime'])) echo round(($sec + $msec) - $conf['headtime'], 3); ?>秒
</div>
</div>
</body>
</html>
